    ...
    return (
      <div className="space-y-6 fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Total Students */}
          <div className="ui-card hover:shadow-lg transition-all" style={{cursor:'pointer'}} onMouseEnter={(e) => e.currentTarget.style.transform='translateY(-2px)'} onMouseLeave={(e) => e.currentTarget.style.transform='translateY(0)'}>
          ...
          <div className="ui-card hover:shadow-lg transition-all" style={{cursor:'pointer'}} onMouseEnter={(e) => e.currentTarget.style.transform='translateY(-2px)'} onMouseLeave={(e) => e.currentTarget.style.transform='translateY(0)'}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-gray-400 mt-1">Teaching staff</div>
              </div>
          ...
          <div className="ui-card hover:shadow-lg transition-all" style={{cursor:'pointer'}} onMouseEnter={(e) => e.currentTarget.style.transform='translateY(-2px)'} onMouseLeave={(e) => e.currentTarget.style.transform='translateY(0)'}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-gray-400 mt-1">Active courses</div>
              </div>
      ...
      <div className="coordinator-topbar">
        <div className="coordinator-topbar-left">
          <div style={{display:'flex', flexDirection:'column'}}>
            <div style={{fontSize:18, fontWeight:700, color:'#fff'}}>Coordinator Panel</div>
            <div className="breadcrumb" style={{color:'rgba(255,255,255,0.85)', marginTop:6}}>
              <a href="#" onClick={(e)=>{e.preventDefault(); setSelectedMenu('dashboard')}}>Home</a>
              <span>/</span>
              <span>Dashboard</span>
            </div>
          </div>
